...
public class servelet2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //out.print("connected");
            PreparedStatement ps = con.prepareStatement("select * from teacherlogindata where tid=? AND tpassword=? ");
            ps.setString(1, tid);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(servelet2.class.getName()).log(Level.SEVERE, null, ex);
